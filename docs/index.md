...
- [A Web Archive snapshot of the TANAP website from 2018 for local browsing]([static/tanap-website.zip](https://github.com/globalise-huygens/tanap.docs.globalise.huygens.knaw.nl/blob/main/docs/static/tanap-website.zip)) (c.65 MB)
